...
const Job = () => {
    return (
        <li className="lg:py-1 mg:py-0 lg:border-t lg:border-r lg:border-l lg:border-b rounded-xl md:border-t md:border-b md:my-0.5 lg:my-1 shadow sm:overflow-hidden md:rounded-md md:overflow-hidden md:shadow md:rounded-md md:shadow">
